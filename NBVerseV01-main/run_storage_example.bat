...
chcp 65001 >nul
echo ========================================
echo NBverse Storage Example Execution
echo ========================================
echo.
...
REM Python 스크립트 실행
echo [3/3] Running storage example...
echo.
...
if errorlevel 1 (
    echo.
    echo Storage example execution failed.
    pause
) else (
    echo.
    echo Storage example completed successfully!
    pause
)
